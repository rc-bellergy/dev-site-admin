...
# Sample to create a Pimcore (X) site:
# sudo python3 newsite.py {domain.dev.dq.hk} pimcorex
...
try:
    webroot = "/public_html"
    if option == "pimcore" or option == "pimcorex":
        webroot = webroot + "/web"
...
elif option == "pimcorex":
    fin = open("php8.conf", "r")
    print("Config php8 website")
else:
